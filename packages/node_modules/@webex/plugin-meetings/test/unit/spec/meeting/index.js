...
import {FLOOR_ACTION, SHARE_STATUS, METRICS_OPERATIONAL_MEASURES, EVENTS, EVENT_TRIGGERS} from '@webex/plugin-meetings/src/constants';
      ...
      describe('share scenarios', () => {
        describe('setUpLocusMediaSharesListener', () => {
          ...
          const generateData = (payload, isGranting, isContent, beneficiaryId, resourceUrl, isAccepting, otherBeneficiaryId) => {
            ...
            newPayload.previous = _.cloneDeep(payload.current);
            ...
            if (isGranting) {
              if (isContent) {
                ...
                if (_.isEqual(newPayload.current, newPayload.previous)) {
          ...
          const payloadTestHelper = (data) => {
            ...
            while (i < callCounter) {
              ...
              for (let idx = 0; idx < share.length; idx += 1) {
                ...
                const {functionName, eventName, eventPayload} = share[i];
          ...
          describe('Whiteboard A --> Whiteboard B', () => {
            it('Scenario #1: you share both whiteboards', () => {
              ...
              const data2 = generateData(data1.payload, false, false, USER_IDS.ME);
              const data3 = generateData(data2.payload, true, false, USER_IDS.ME, RESOURCE_URLS.WHITEBOARD_B);
              const data4 = generateData(data3.payload, false, false, USER_IDS.ME);
