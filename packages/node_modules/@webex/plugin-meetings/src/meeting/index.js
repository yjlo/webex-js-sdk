  ...
  */
  ...
  setUpLocusMediaSharesListener() {
    ...
    this.locusInfo.on(EVENTS.LOCUS_INFO_UPDATE_MEDIA_SHARES, (payload) => {
      ...
      // or if content sharing has been stopped and there is no whiteboard share
      else if (
        (previousContentShare &&
        contentShare.disposition === FLOOR_ACTION.RELEASED) && 
  ...
  startWhiteboardShare(board, resourceToken) {
    ...
    if (whiteboard && !this.isSharingWhiteboard) {
        ...
        .catch((error) => {
          ...
          Metrics.sendOperationalMetric(
            METRICS_OPERATIONAL_MEASURES.MEETING_START_WHITEBOARD_SHARE_FAILURE,
            {
              ...
              reason: error.message,
              stack: error.stack,
              board: {channelUrl: board?.channelUrl, channelId: board?.channelId}, 
            }
          );
