  ...
  */
  ...
  setUpLocusMediaSharesListener() {
    ...
    this.locusInfo.on(EVENTS.LOCUS_INFO_UPDATE_MEDIA_SHARES, (payload) => {
      ...
      if (whiteboardShare?.resourceUrl) {
        this.channelUrl = whiteboardShare.resourceUrl;
      }
      ...
      // think about if whiteboard was never shared we don't get disposition
      else if (
        (previousContentShare &&
        contentShare.disposition === FLOOR_ACTION.RELEASED) && (previousWhiteboardShare &&
        whiteboardShare.disposition !== FLOOR_ACTION.GRANTED)
      ) {
  ...
  startWhiteboardShare(board, resourceToken) {
    ...
    if (whiteboard) {
      ...
      const body = {
        ...
        deviceUrl: this.deviceUrl,
        uri: whiteboard.url,
        resourceUrl: board?.channelUrl || this.channelUrl,
      };
      if (resourceToken) {
      ...
      return this.meetingRequest.changeMeetingFloor(body)
        .then(() => {
          ...
          this.mediaProperties.mediaDirection.receiveShare = true;
  ...
  stopWhiteboardShare() {
    ...
    if (whiteboard && (this.mediaProperties.mediaDirection.sendShare)) {
  ...
  changeVideoLayout(layoutType, renderInfo = {}) {
    ...
    if (whiteboard?.floor === undefined || whiteboard?.floor?.disposition !== 'GRANTED') {
