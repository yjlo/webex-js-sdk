...
export default class MeetingRequest extends StatelessWebexPlugin {
  ...
  /**
   * Clean up function for Media Request after addMedia fails
   * @param {Object} options options for clean up media request
   * @param {String} options.locusUrl Locus url
   * @param {String} options.locusId Locus Id
   * @param {String} options.selfId self Id
   * @param {String} options.mediaId Media Id
   * @returns {Promise}
   */
  deleteMediaRequest(options) {
    delete options.mediaRequestSent;
    const uri = `${options.locusUrl}/${PARTICIPANT}/${options.selfId}/${MEDIA}/${options.mediaId}`;
